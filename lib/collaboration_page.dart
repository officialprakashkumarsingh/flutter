  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            // Clean minimal header like homescreen
            Container(
              ...
              child: Column(
                ...
                children: [
                  // Title using homescreen AhamAI font
                  Text(
                    'Collabs',
                      ...
                      Expanded(
                        child: OutlinedButton(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              const Icon(Icons.group_add, size: 14),
                              const SizedBox(width: 6),
                              Text(
                                'Join',
                                style: GoogleFonts.inter(
  ...
  Widget _buildRoomsList() {
    return Column(
      children: [
        ...
        // Clean rooms list like chat list
        Expanded(
          child: RefreshIndicator(
            ...
            child: ListView.builder(
              padding: EdgeInsets.zero, // No padding - full screen
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              // No icon - clean text-only design
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
