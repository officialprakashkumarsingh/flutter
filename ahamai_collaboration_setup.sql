-- ==========================================
-- AHAMAI COMPLETE SETUP WITH COLLABORATION
-- ==========================================
...
-- You can uncomment this section if you want some sample collaboration rooms
-- INSERT INTO public.collaboration_rooms (name, description, invite_code, created_by) VALUES
-- ('General Discussion', 'Open discussion room for everyone', 'GENERAL123', '00000000-0000-0000-0000-000000000000'),
-- ('Study Group', 'Mathematics and Science study group', 'STUDY456', '00000000-0000-0000-0000-000000000000');

-- ==========================================
-- SETUP COMPLETE!
-- ==========================================

SELECT 'AhamAI Complete Setup with Collaboration Completed Successfully!' as status,
       'All existing data has been deleted and fresh setup with collaboration created' as warning,
       'Collaboration features: Rooms, Real-time messaging, Member management' as features,
